export default function Home() {
  return (
    <main className='min-h-full w-full bg-red-100 p-1'>
      ...
      <p className='text-justify w-1/2 mx-auto mt-2'><span className='font-bold'>SaxoServer</span> is a music practicing tool designed to help you improve your skills with a daily set of practice exercises. Begin with a warmup before practicing your scales, and then move onto some more technical exercises. Then, put in some time practicing a selection from your personal list of pieces that you want to improve.</p>
    </main>
  )
};

// smth like adolphe sax had so much fun naming things after himself, we figured we had to do it too (links to saxocannon, saxophone, saxhorns)